...
Plans:
- [x] 27-01-PLAN.md — Implement memory preference persistence plus CLI/API/UI inspection and edit controls.
...
Plans:
- [x] 28-01-PLAN.md — Implement local embeddings, scoped vector retrieval, and visible retrieval metadata.
