# Requirements Archive: v1.9 Rust Runtime Hardening
...
- [x] **ARCH-05**: Rust concern map documented in `AGENTS.md`; `check-rust-boundaries` script wired into `npm run check:rust`.
