...
Plans:
- [x] 61-01-PLAN.md — Extract shared types, API helpers, and design tokens
- [x] 61-02-PLAN.md — AppShell + TopBar with session/SSE state and view routing
- [x] 61-03-PLAN.md — GraphCanvas, ExecutionNodeCard (002-B), NodeContextMenu
- [x] 61-04-PLAN.md — Slim Run panel on node select with responsive layout
- [x] 61-05-PLAN.md — Full-screen Advanced hub with lazy domain views
- [x] 61-06-PLAN.md — Monolith teardown, build verification, REG-01 UAT
